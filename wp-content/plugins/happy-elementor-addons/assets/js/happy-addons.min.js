      ...
      n = t.extend({
        ...
        getSlickSettings: function () {
          ...
          return (
            ...
            (t.slidesToScroll =
              (e && parseInt(this.getElementSettings("slides_to_show"))) || 1),
            (t.responsive = [
              {
      ...
      o = t.extend({
        ...
        run: function () {
          ...
          0 != this.wrapper.length &&
            ...
            (o = "normal"),
            (s = 10),
            (r = { transform: "translateX(0" + r + "px)" }),
            "right" === n && (o = "reverse"),
            t.each(function () {
              s += c(this).outerWidth(!0);
            }),
            e.css({ width: s, display: "flex" }),
            c.keyframe.define([
              { name: a, "0%": r, "100%": { transform: "translateX(-101%)" } },
            ]),
            e.playKeyframe({
              name: a,
                      ...
                      w.css("display", "none"),
                        ...
                        !0 !== a
                          ? (m.removeAttr("style"),
                            ...
                            (w = "Invalid Data"),
                            o < s && (w = n(t(s))),
                            m.find("span.ha-ec-event-time").text(h + " - " + w))
                          : (m.removeAttr("style"),
        ...
        elementorFrontend.isEditMode()
          ? (localStorage.removeItem("ha-age-gate-expire-time"),
            e.find(".ha-age-gate-wrapper").length &&
              "no" == e.find(".ha-age-gate-wrapper").data("editor_mood") &&
          ...
          : elementorFrontend.isEditMode() ||
            ...
            e.find(".ha-age-gate-wrapper.ha-age-gate-confirm-age").length &&
            ...
            e.find(".ha-age-gate-wrapper.ha-age-gate-confirm-dob").length &&
